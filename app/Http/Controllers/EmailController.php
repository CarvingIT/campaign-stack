...
class EmailController extends Controller
{
    ...
    private function formatSentEmail($email)
    {
        return [
            ...
            'campaign_name' => $email->newsletter?->campaign?->name ?? 'Transactional Dispatch',
    ...
    public function details($id)
    {
        ...
        if ($sent) {
            return response()->json([
                ...
                'campaign_name' => $sent->newsletter?->campaign?->name ?? 'Transactional Dispatch',
                'newsletter_title' => $sent->newsletter?->title ?? 'Direct API Email',
        ...
        if ($queued) {
            ...
            return response()->json([
                ...
                'campaign_name' => $queued->newsletter?->campaign?->name ?? 'Transactional Dispatch',
                'newsletter_title' => $queued->newsletter?->title ?? 'Direct API Email',
