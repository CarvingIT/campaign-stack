                                ...
                                <div class="px-4 py-5 bg-white sm:p-6 text-gray-900">
                                    <div class="grid grid-cols-12 gap-6">
                                        ...
                                        <div class="col-span-12 md:col-span-4 flex flex-col gap-2">
                                            ...
                                            <div class="col-span-4 md:col-span-4">
                                                <label class="block font-medium text-sm" for="campaign_id">Campaign</label>
                                                <select class="form-input rounded-md shadow-sm mt-1 block w-full" id="campaign_id" name="campaign_id" required>
