    ...
    <div class="px-4 py-5 bg-white sm:p-6 text-gray-900">
       <div class="grid grid-cols-6 gap-6">
        ...
        <div class="col-span-4 md:col-span-2">
             <label class="block font-medium text-sm" for="label">Label</label>
             <input class="form-input rounded-md shadow-sm mt-1 block" id="label" name="label" type="text" value="{{ $tag->label }}" >
        </div>
       </div>
    </div>
