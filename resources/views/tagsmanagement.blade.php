    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="text-right">
                <a class="m-5" title="New Book" href="/tag-form/new"><span class="fas fa-plus"></span></a>
                <!--a class="m-5" title="Export" href="/export/tags"><span class="fas fa-file-export"></span></a-->
            </div>
                <div class="mt-6 text-gray-900">
            <div class="table-responsive">
                    <table id="tags" class="table table-bordered  display stripe hover" style="width:100%">
