    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="/account-form/{{ $account->id }}" class="inline-flex items-center px-4 py-2 bg-zinc-900 hover:bg-zinc-800 text-white dark:bg-zinc-100 dark:hover:bg-white dark:text-zinc-950 text-xs font-bold rounded-xl shadow-2xs transition-all gap-2">
            ...
            <div class="bg-white dark:bg-[#141417] rounded-2xl p-6 shadow-2xs border border-zinc-200/80 dark:border-zinc-800 space-y-5">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-100 dark:border-zinc-800 pb-4">
                    <div class="flex items-center space-x-4">
                        <div class="w-12 h-12 rounded-2xl bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-700 flex items-center justify-center text-xl shrink-0">
            ...
            <div class="bg-white dark:bg-[#141417] rounded-2xl p-6 shadow-2xs border border-zinc-200/80 dark:border-zinc-800 space-y-5">
                <div class="border-b border-zinc-100 dark:border-zinc-800 pb-3 flex items-center justify-between">
                    <h4 class="text-base font-bold text-zinc-900 dark:text-white flex items-center gap-2">
                        <i class="fas fa-cogs text-zinc-800 dark:text-zinc-200"></i>
