...
function showDeleteDialog(book_id){
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="text-right">
                <a class="m-5" title="New Book" href="/account-form/new"><span class="fas fa-plus"></span></a>
                <!--a class="m-5" title="Export" href="/export/accounts"><span class="fas fa-file-export"></span></a-->
            </div>
                <div class="mt-6 text-gray-900">
            <div class="table-responsive">
                    <!--table id="accounts" class="table table-bordered  display stripe hover" style="width:100%"-->
                    <table id="accounts" class="table table-bordered  display stripe hover" style="width:100%">
            ...
            <td>
                ...
                <a href="/account-form/{{ $c->id }}" title="Edit"><span class="fas fa-pencil-alt" style="padding:5%;"></span></a>
                ...
                <form name="deletedoc" method="post" action="/account/delete">
                @csrf
                <input type="hidden" id="delete_book_id" name="book_id" value="{{ $c->id }}" />
